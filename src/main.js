...
function render() {
  ...
  // Оновлення статистики (Використовуємо функцію з logic.js)
...
btn.addEventListener("click", () => {
  ...
  if (result === "ok") {
    ...
    alert(result); // Виведе помилку з logic.js
  }
});

// 5. Обробка кліків на кнопки в списку
